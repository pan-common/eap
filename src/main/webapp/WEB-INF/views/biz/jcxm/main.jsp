...
<script type="text/javascript">
    ...
    layui.use([ 'layer', 'form' ], function(layer, form) {
        ...
        $("#addBtn").click(function () {
            showModel("新增","${pageContext.request.contextPath}/sysResource/link?url=biz/jcxm/form&jcxmId=0","550px","550px");
        });
        //弹出录入框
        ...
        $('#bootstrapTable').bootstrapTable({
            url:"${pageContext.request.contextPath}/jcxm/list",
            method:'GET',
            ...
            uniqueId : "jcxmId", //每一行的唯一标识，一般为主键列
                ...
                },
                {
                    ...
                    events : {
                        'click .edit' : function(e, value, row, index) {
                            ...
                            showModel("编辑","${pageContext.request.contextPath}/sysResource/link?url=biz/jcxm/form&jcxmId="+row.jcxmId,"550px","550px");
                        },
    ...
    function del(jcxmId) {
        layer.confirm("删除数据不可恢复，请确认？",{
            ...
            $.post('${pageContext.request.contextPath}/jcxm/delete',
                    {jcxmId : jcxmId},
                    function (data, status) {
                        if (status == "success") {
                            if (data.body.resultCode == "0") {
