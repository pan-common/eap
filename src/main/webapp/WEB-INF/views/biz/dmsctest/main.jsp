...
<script type="text/javascript">
    layui.use([ 'layer', 'form' ], function(layer, form) {
        ...
        $("#addBtn").click(function () {
            showModel("新增","${pageContext.request.contextPath}/sysResource/link?url=biz/dmsctest/form&testId=0","550px","550px");
        });
        //弹出录入框
        ...
        $('#bootstrapTable').bootstrapTable({
            url:"${pageContext.request.contextPath}/dmsctest/list",
            method:'GET',
                ...
                },
                {
                    ...
                    events : {
                        'click .edit' : function(e, value, row, index) {
                            ...
                            showModel("编辑","${pageContext.request.contextPath}/sysResource/link?url=biz/dmsctest/form&testId="+row.testId,"550px","550px");
                        },
    ...
    function del(testId) {
        layer.confirm("删除数据不可恢复，请确认？",{
            ...
            $.post('${pageContext.request.contextPath}/dmsctest/delete',
                    {testId : testId},
