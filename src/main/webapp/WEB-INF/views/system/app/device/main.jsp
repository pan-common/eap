...
<script type="text/javascript">
    layui.use([ 'layer', 'form' ], function(layer, form) {
        ...
        $("#addBtn").click(function () {
            showModel("新增","${pageContext.request.contextPath}/sysResource/link?url=system/app/device/form&deviceId=0","550px","550px");
        });
        //弹出录入框
                ...
                },
                {
                    ...
                    events : {
                        'click .edit' : function(e, value, row, index) {
                            ...
                            showModel("编辑","${pageContext.request.contextPath}/sysResource/link?url=system/app/device/form&deviceId="+row.deviceId,"550px","550px");
                        },
    ...
    function del(deviceId) {
        layer.confirm("删除数据不可恢复，请确认？",{
            ...
            $.post('${pageContext.request.contextPath}/device/delete',
                    {deviceId : deviceId},
