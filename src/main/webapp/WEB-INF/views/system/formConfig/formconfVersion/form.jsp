...
<form id="form" class="layui-form" style="margin-top: 20px" lay-filter="form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-right: 10px;width: 300px">
            <input type="text" name="versionNumber"  lay-verify="number" placeholder="请输入版本号" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">版本注释</label>
        <div class="layui-input-block" style="margin-right: 10px;width: 300px">
            <input type="text" name="versionNote"  lay-verify="required" placeholder="请输入版本注释" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <input id="formVersionId" type="hidden" name="formVersionId">
...
<script type="text/javascript">
    var formVersionId = ${param.formVersionId};
    var url = "${pageContext.request.contextPath}/formconfVersion/add";
    layui.use(['form'],function () {
        var form = layui.form;
        form.render();

        if(formVersionId){
            url = "${pageContext.request.contextPath}/formconfVersion/edit";
            $.get("${pageContext.request.contextPath}/formconfVersion/selectOne",{
