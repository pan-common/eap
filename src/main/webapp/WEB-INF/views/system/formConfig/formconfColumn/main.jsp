...
<script type="text/javascript">
    layui.use([ 'layer', 'form' ], function(layer, form) {
        ...
        $("#addBtn").click(function () {
            showModel("新增","${pageContext.request.contextPath}/sysResource/link?url=system/formConfig/formconfColumn/form&columnId=0","550px","550px");
        });
        //弹出录入框
        ...
        $('#bootstrapTable').bootstrapTable({
            url:"${pageContext.request.contextPath}/formconfColumn/list",
            method:'GET',
            ...
            uniqueId : "columnId", //每一行的唯一标识，一般为主键列
                ...
                },
                {
                    ...
                    events : {
                        'click .edit' : function(e, value, row, index) {
                            ...
                            showModel("编辑","${pageContext.request.contextPath}/sysResource/link?url=system/formConfig/formconfColumn/form&columnId="+row.columnId,"550px","550px");
                        },
    ...
    function del(columnId) {
        layer.confirm("删除数据不可恢复，请确认？",{
            ...
            $.post('${pageContext.request.contextPath}/formconfColumn/delete',
                    {columnId : columnId},
