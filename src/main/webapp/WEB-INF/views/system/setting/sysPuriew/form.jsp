...
<form id="form" class="layui-form" style="margin-top: 20px" lay-filter="form">
        ...
        <div class="layui-input-block" style="margin-right: 10px;width: 300px">
                            <input type="text" name="expression"  lay-verify="required" placeholder="请输入权限表达式" autocomplete="off" class="layui-input">
        </div>
    </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    layui.use(['form'],function () {
        ...
        if(puriewId){
            url = "${pageContext.request.contextPath}/sysPuriew/edit";
            $.get("${pageContext.request.contextPath}/sysPuriew/selectOne",{
                puriewId:puriewId
