                            ...
                            <form id="form" class="layui-form" style="margin-top: 20px" lay-filter="form">
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="2"><input type="text" id="schema" name="schema" readOnly="true"
                                                               class="layui-input"></td>

                                        <td><label class="layui-form-label">表名</label></td>
                                        <td colspan="2"><input type="text" id="tableName" name="tableName"
                                                               readOnly="true" class="layui-input"></td>
                                    </tr>
                                    <tr>
                                        <td><label class="layui-form-label">包名</label></td>
                                        <td><input id="packageName" type="text" name="packageName" readOnly="true"
                                                   class="layui-input"></td>
                                        <td>
                                            <button id="selectPackage" class="layui-btn layui-btn-small" type="button">
                                                选择
                                            </button>
                                        </td>

                                        <td><label class="layui-form-label">页面路径</label></td>
                                        <td><input id="pagePath" type="text" name="pagePath" readOnly="true"
                                                   class="layui-input"></td>
                                        <td>
                                            <button id="selectPagePath" class="layui-btn layui-btn-small" type="button">
                                                选择
                                            </button>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div>
                                                <input required lay-verify="required" type="radio" name="deleteWay"
                                                       value="01" title="逻辑">
                                                <input required lay-verify="required" type="radio" name="deleteWay"
                                                       value="02" title="物理" checked>
                                            </div>
                                        </td>

                                        <td><label class="layui-form-label">别名</label></td>
                                        <td><input type="text" name="alias" placeholder="请输入别名" required
                                                   lay-verify="required" class="layui-input"></td>
                                        <td>
                                            <label class="layui-form-label">作为包名</label>
                                            <input type="checkbox" name="aliasUse" lay-skin="switch" lay-text="开|关"
                                                   value="1" checked>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td id="nameInput" colspan="2">
                                            <input id="nameField" type="text" value="name" name="nameField"
                                                   class="layui-input">
                                        </td>
                                        <td id="parentFieldLabel"><label class="layui-form-label">父ID字段</label></td>
                                        <td id="parentFieldInput" colspan="2">
                                            <input id="parentField" type="text" value="parent_id" name="parentField"
                                                   class="layui-input">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="menuLabel" type="text" name="menuLabel" readOnly="true"
                                                   class="layui-input"></td>
                                        <td>
                                            <button id="selectMenu" type="button" class="layui-btn layui-btn-small">选择
                                            </button>
                                        </td>
                                    </tr>
                                    <tr>
...
<script type="text/javascript">
    ...
    layui.use(['layer', 'form'], function (layer, form) {
        ...
        $.get("${pageContext.request.contextPath}/generator/getTables", {}, function (data, status) {
            if (status == "success") {
                if (data.body.resultCode == "0") {
                    layui.tree({
                        elem: '#tables', //传入元素选择器
