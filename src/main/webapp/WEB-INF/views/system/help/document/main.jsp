...
<script type="text/javascript">
    ...
    layui.use([ 'layer', 'form' ], function(layer, form) {
        ...
        $("#addBtn").click(function () {
            showModel("新增","${pageContext.request.contextPath}/sysResource/link?url=system/help/document/form&documentId=0","550px","550px");
        });
        $("#showTreeView").click(function () {
            showModel("显示树","${pageContext.request.contextPath}/sysResource/link?url=system/help/document/treeView","550px",$(window).height())
        });
        $("#showZTree").click(function () {
            showModel("显示树","${pageContext.request.contextPath}/sysResource/link?url=system/help/document/zTree","550px",$(window).height())
        });
        //弹出录入框
        ...
        $('#bootstrapTable').bootstrapTable({
            ...
            uniqueId : "documentId", //每一行的唯一标识，一般为主键列
                ...
                },
                {
                    ...
                    events : {
                        ...
                        'click .edit' : function(e, value, row, index) {
                            ...
                            showModel("编辑","${pageContext.request.contextPath}/sysResource/link?url=system/help/document/form&documentId="+row.documentId,"550px","550px");
                        },
    ...
    function del(documentId) {
        layer.confirm("删除数据不可恢复，请确认？",{
            ...
            $.post('${pageContext.request.contextPath}/document/delete',
    ...
    function loadPath() {
        $.get('${pageContext.request.contextPath}/document/getPath/',
                {
                    ...
                    if (status == "success") {
                        if (data.body.resultCode == "0") {
                            ...
                            for (var i = 0; i < result.length; i++) {
                                ...
                                +result[i].documentId+'">'+ result[i].documentTitle+'</a></li>';
                                $(".breadcrumb").append(html);
                                $("a[name=" + result[i].documentId + "]").bind("click", {
                                    index : i
                                }, clickHandler);
                            }
                            function clickHandler(event) {
                                var i = event.data.index;
                                currentId = result[i].documentId;
                                refreshTable();
                                loadPath();
                            }
                        }
