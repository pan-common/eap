...
<script type="text/javascript">
    ...
    layui.use([ 'layer', 'form' ], function(layer, form) {
        ...
        $("#addBtn").click(function () {
            showModel("新增","${pageContext.request.contextPath}/sysResource/link?url=wsm/water/ConfigTree/form&id=0","550px","550px");
        });
        $("#showTreeView").click(function () {
            showModel("显示树","${pageContext.request.contextPath}/sysResource/link?url=wsm/water/ConfigTree/treeView","550px",$(window).height())
        });
        $("#showZTree").click(function () {
            showModel("显示树","${pageContext.request.contextPath}/sysResource/link?url=wsm/water/ConfigTree/zTree","550px",$(window).height())
        });
        //弹出录入框
        ...
        $('#bootstrapTable').bootstrapTable({
            url:"${pageContext.request.contextPath}/ConfigTree/list",
            method:'GET',
                ...
                },
                {
                    ...
                    events : {
                        ...
                        'click .edit' : function(e, value, row, index) {
                            ...
                            showModel("编辑","${pageContext.request.contextPath}/sysResource/link?url=wsm/water/ConfigTree/form&id="+row.id,"550px","550px");
                        },
    ...
    function del(id) {
        layer.confirm("删除数据不可恢复，请确认？",{
            ...
            $.post('${pageContext.request.contextPath}/ConfigTree/delete',
                    {id : id},
    ...
    function loadPath() {
        $.get('${pageContext.request.contextPath}/ConfigTree/getPath/',
                {
                    id : currentId
                }, function(data, status) {
                    if (status == "success") {
                        if (data.body.resultCode == "0") {
                            ...
                            for (var i = 0; i < result.length; i++) {
                                ...
                                +result[i].id+'">'+ result[i].title+'</a></li>';
